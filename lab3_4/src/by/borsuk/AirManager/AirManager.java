...
public class AirManager {
    ...
    protected static final Logger log = Logger.getLogger(AirManager.class.getName());


    private static AirManager ourInstance = new AirManager();

    public static AirManager getInstance() {
        log.info(" AirManager query");
        return ourInstance;
    }
...
// генерирует заданное количество самолетов определенного вида со
    ...
    public Airport generateAirportFromXML(String filepath) throws
